...
public class ClientWorkerWithQueryTest {
    ...
    private static final String TEST_QUERY = "* | WHERE request_method = 'GET'";
    ...
    public static void main(String[] args) throws LogHubClientWorkerException,
        ...
        for (int i = 0; i < n; i++) {
            LogHubConfig config = new LogHubConfig(
                    "consumer_group_query_worker_test", "consumer_" + i,
                    TEST_ENDPOINT, TEST_PROJECT, TEST_LOGSTORE,
                    ACCESS_KEY_ID, ACCESS_KEY,
                    LogHubConfig.ConsumePosition.BEGIN_CURSOR, TEST_QUERY);
